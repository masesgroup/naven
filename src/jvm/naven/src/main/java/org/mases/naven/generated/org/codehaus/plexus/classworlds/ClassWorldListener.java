...
package org.mases.naven.generated.org.codehaus.plexus.classworlds;

public final class ClassWorldListener implements org.mases.jcobridge.IJCListener, org.codehaus.plexus.classworlds.ClassWorldListener {
     ...
     */
    public ClassWorldListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _realmCreatedIndex = 0;
    //@Override
    public void realmCreated(org.codehaus.plexus.classworlds.realm.ClassRealm arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_realmCreatedIndex <= 0) _realmCreatedIndex = getEventIndex("realmCreated");
        raiseEvent(_realmCreatedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _realmDisposedIndex = 0;
    //@Override
    public void realmDisposed(org.codehaus.plexus.classworlds.realm.ClassRealm arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_realmDisposedIndex <= 0) _realmDisposedIndex = getEventIndex("realmDisposed");
        raiseEvent(_realmDisposedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
